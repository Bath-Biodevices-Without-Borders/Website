  ...
  return (
    <div className="main_container">
      ...
      <div className="issue-card">
        ...
        <div className="issue-part-two"><img className='africa-map' src="./images/map-redone-transformed.png" alt="Africa Map" /></div>
      </div>
      <div className='our-mission'>
        ...
        <img src="./images/team_pic_old-removebg.png" alt="Team" />
      </div>
      <div className="our-solution">
        <div className="solution-container-one">
          <img src="./images/OASIS_Device.png" alt="Oasis Device" />
        </div>
